...
/* ─────────────────────────────────────────────
   SMOOTH SCROLL
   Intercepts every <a href="#..."> click on the page.
   Uses requestAnimationFrame-based easing so it works
   regardless of overflow settings on html/body.
───────────────────────────────────────────── */
(function initSmoothScroll() {
  ...
  function goTo(id) {
    ...
    if (!el) return;
    var y = el.getBoundingClientRect().top + window.scrollY - NAV_H;
